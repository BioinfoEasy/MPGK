...
then
	...
	Rscript PRSice.R --dir . --prsice ./PRSice_mac --base re1.assoc.logistic --target target_bi --thread 1 --stat OR --binary-target T --pheno phe2.txt
	Rscript PRSice.R --dir . --prsice ./PRSice_mac --base re1.assoc.logistic --target target_bi --thread 1 --stat OR --binary-target T --pheno phe2.txt --extract PRSice.valid	
